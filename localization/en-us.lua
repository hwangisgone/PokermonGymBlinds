return {
	descriptions = {
		Blind = {
			...
			bl_pkrm_gym_thunder = {name = 'The Thunder', text = {"Lose 5$","every Discard"}},
			bl_pkrm_gym_rainbow = {name = 'The Rainbow', text = {"Wild and Polychrome cards", "are debuffed"}},
			bl_pkrm_gym_soul    = {name = 'The Soul'   , text = {"After Discard,", "remove enhancement", "from all cards held in hand"}},
			-- bl_pkrm_gym_soul_janine = {name = 'The Soul'   , text = {"1 in 6 cards drawn", "get debuffed"}},
			...
			bl_pkrm_gym_volcano = {name = 'The Volcano', text = {"Pokermon Quiz"}},
			bl_pkrm_gym_earth   = {name = 'The Earth'  , text = {"Giovanni's Gym"}},
			bl_pkrm_gym_e4_lorelei = {name = 'Temp Bruno', text = {"Elite Four - 1"}},
			bl_pkrm_gym_e4_bruno   = {name = 'Saffron Belt', text = {"Destroy cards played", "on first and last hand"}},
			...
			bl_pkrm_gym_e4_koga  = {name = 'Fuchsia Poison', text = {"After Discard, remove", "enhancement and edition", "from all cards held in hand"}},
